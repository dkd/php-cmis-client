...
interface QueryResultInterface
{
     ...
     *
     * @return AllowableActionsInterface|null the allowable actions if they have been requested, null otherwise
     */
     ...
     *
     * @return PropertyDataInterface[] all properties, not null
     */
     ...
     *
     * @param string $id
     * @return PropertyDataInterface|null the property or null if the property doesn't
     ...
     * @return PropertyDataInterface|null the property or null if the property doesn't exist
     ...
     * @return array|null the property value or null if the property doesn't exist, hasn't been requested,
     ...
     *
     * @param string $queryName the property query name or alias
     * @return mixed the property value or null if the property doesn't exist, hasn't been requested,
     * or the property value isn't set
     */
